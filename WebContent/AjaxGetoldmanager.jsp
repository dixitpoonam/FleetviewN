...
//	con1 = DriverManager.getConnection(MM_dbConn_STRING,MM_dbConn_USERNAME,MM_dbConn_PASSWORD);
	...
	//25Sep17 sql="select UserName,Email,FirstName,LastName from db_gps.t_userdetails where Transporter like '%"+usertypevalue+"%' and UserName like '%"+oldmanagername+"%' order by UserName asc";
