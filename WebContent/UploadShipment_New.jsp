...
<jsp:useBean id="fleetview" class="com.fleetview.beans.classes"
	...
	<form name="uploadTask" method="post" enctype="multipart/form-data"
		onsubmit="return confirmSubmit()" action="ShipmentInsert.jsp">

		<table border="0" align="center" width="100%">
			<tr>
				<td align="center"><font color="black" size="3"><b><i>Upload
								Total Shipment</i></b></font></td>
			</tr>
		</table>
		...
		<table border="0" width="100%" align="center">
			...
			<tr align="center">
				<td align="center"><a href="ShipmentReport.jsp">Shipment
						Details Report</a></td>

			</tr>

			<tr>
				<!-- Code For Sample format Downlod  -->
				<td align="right" width="100%" colspan="2"><font size="2"><b>Sample
							Format</b> </font> <a
					href="http://myfleetview.net/FleetView/ddgimages/Shipment.xls"
					style="font-weight: bold; color: black;"> <img
						src="images/excel.jpg" width="20px" height="20px"
						style="border-style: none" title="download excel format"></img></a></td>
			</tr>
			<tr>
				<td align="center" bgcolor="#f5f5f5"><font size="2"><b>Browse
							excel file :</b></font> <INPUT NAME="file" id="file" TYPE="file" size="20">
				</td>
			</tr>
			<br>
		</table>
		...
		<table border="0" width="100%" align="center">
			<tr>
				<td bgcolor="#f5f5f5" align="center"><font size="2"><b><input
							type="submit" name="uploadexl" id="uploadexl" value="Submit" /></b></font></td>
			</tr>
		</table>
