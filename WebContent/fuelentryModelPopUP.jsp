						...
						<div class="col-md-12 col-12">
							<div class="card">
								...
								<div class="card-body card">
									<!-- Start card body -->
 <form name="fuelform" method="get" action=" " onSubmit="return validate();">
                     <%
...
<%-- 													<button class="btn btn-primary btn2" type="button"><a href="AddNewDriver.jsp?transporter=<%=user%>"><font style="color:#FFFFFF;">Add New Driver</font></a></button>
 --%>												</div>
										...
										<div class="d-grid gap-2 col-5 mx-auto tcolor">
										  <div class="mt-1">
...
<div class="modal" id="myModal"style="color:gray;" tabindex="-1">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h6 class="tcolor">Add New Driver</h6>
				<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
			</div>
	     <form  action="add_driver_action.jsp" method="post" id="newModalForm">   
			...
			<div class="modal-footer">
				...
				<%-- <% response.sendRedirect("fuelentryModelPopUP.jsp"); %> --%>
			</div>
	   </form>
