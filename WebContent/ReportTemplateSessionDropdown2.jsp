		...
		<div class="row">  <!-- row main start -->  
		   <div class="row col-11">  <!--  row 1 -->
		    ...
		    <div class="col-md-2">  <!-- col 3-->
		         <label for="basicSelect">Dropdown</label>
					<div class="input-group input-group-merge">
							<select class="form-select" id="basicSelect1" name="basicSelect1">
		    ...
		    <div class="col-md-2"> <!-- col 4 -->
		         <label for="basicSelect">Dropdown</label>
					<div class="input-group input-group-merge">
							<select class="form-select" id="basicSelect2" name="basicSelect2">
								<option>Active</option>
								<option>DeActive</option>
								<option>All</option>
							</select>
		      ...
		      <div class="col-md-2"> <!-- col 5 -->
		         <label for="basicSelect">Dropdown</label>
					<div class="input-group input-group-merge">
							<select class="form-select" id="basicSelect3" name="basicSelect3">
								<option>Active</option>
								<option>DeActive</option>
								<option>All</option>
							</select>
		      ...
		      <div class="col-md-2"> <!-- col 6 -->
		         <label for="basicSelect">Dropdown</label>
					<div class="input-group input-group-merge">
							<select class="form-select" id="basicSelect4" name="basicSelect4">
								<option>Active</option>
								<option>DeActive</option>
								<option>All</option>
							</select>
							<script>
			                         const mySel = document.getElementById("basicSelect4"); 
			                         mySel.addEventListener("change",function() 
					                     { 
						                       localStorage.setItem("selValue",this.value); // save it 
					                     }); 
