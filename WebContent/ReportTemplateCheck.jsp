...
nodes=[];
  function ondemand(){
	  ...
	  const element = document.getElementById("example1");
		...
		//alert("in method...3"+nodes.length);
...
window.onload = function{
	if(document.getElementById("extAll").value.checked){
...
{
	//alert("check/uncheck: "+document.formreport.extAll.checked);
	 
	if(document.formreport.extAll.checked) 
	{
		document.getElementById("fromdate").style.display='none';
    	document.getElementById("todate").style.display='none';
    }
...
System.out.println(" buttom :- "+bt);
    ...
    CheckSelection = request.getParameter("extAll");
	System.out.println("checkbox selection:"+CheckSelection);
	
	Selection = request.getParameter("basicSelect");
	System.out.println("dropdown selection:"+Selection);
	...
	<div class="content-wrapper container-xxl p-0">
		...
		<button class="engage-help-toggle btn  btn-primary h-35px  btn-color-gray-700 btn-active-color-gray-900 shadow-sm rounded-top-0" data-bs-toggle="modal" data-bs-target="#registerComplaintModal">
		    ...
		    <div class="col-md-1">
                 ...
                 <div class="input-group input-group-merge" >
                 <input type="checkbox" class="form-check-input" id="extAll" name="extAll" value="yes" onclick="allSelected(this.value);">
                 </div>
            </div>
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Report</h4>
