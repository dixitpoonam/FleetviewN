			...
			<div class="content-header row">
				<div class="content-header-left col-md-7 col-12 mb-2">
					<div class="row breadcrumbs-top">
						<div class="col-6">
							<h3 class="content-header-title  mb-0" style="color: #060637">Add Edit Employee Details</h3>
						</div>
					</div>
				</div>
				<div
...
{//1 gps 
	...
	%>
									<div class="d-grid col-5 mx-auto mb-1">
												<label  class="tcolor"><b>Owner Name:</b></label><br>
												<div class="input-container">
													<select class="form-select"
													 name="owner" id="owner" onchange="formsubmit();"
									...
									<div class="d-grid col-5 mx-auto mb-1">
												...
												<label  class="tcolor"><b>Vehicles:</b></label><br>
												<div class="input-container">
													<select class="form-select"
													 name="vehcles" id="vehcles" onchange="formsubmit1();"
														aria-label="Default select example">
												    <option value="Select">Select</option>
														 <%
													 			if(!(null==Vehicle))
									...
									if(!(null==Vehicle))
 			                         {
 			                    	%>
									<section class="sectionCSs mb-1">
									<div class="row"> 
									<label class="tcolor" style=color:orange;>Current EMP Name And Code</label>
									 <div>
									    <%
									...
									<div>
									 ...
									 <%if(request.getParameter("vehcles").equalsIgnoreCase("Select")) { %>
									<div id="showmanager">
									  <input class="form-control" type="hidden" name="oldmanager" id="oldmanager" value="">
									...
									<div class="mt-1">
									 ...
									 <input class="form-check-input" type="checkbox" name="extAll" id="extAll" value="yes"  onclick="allSelected();"/>(Select check BOX Here)
									</div>
									
									<div id="tr1" class="row" style="display: none;">
									 <label class="tcolor">New EMP Name:</label>
									 <input class="form-control" type="text"
									 placeholder="Enter Employee name" name="empname" id="empname" onblur="empval()"></input>
									...
									<div id="tr2" class="row" style="display: none;">
									 <label class="tcolor">New EMP Code:</label>
									 <input class="form-control" type="text"
									 placeholder="Enter Employee code" name="empcode" id="empcode" onblur="codeval()"></input>
									  <label name="coden" id="coden" style="display: none;"><font color="red">Please Enter Emp code</font></label>
									</div>
									
									<div id="tr4" class="row" style="display: none;">
									 <label class="tcolor">New Fleetview ID:</label>
									 <div>
									   <input type="text" name="newempid" id="newempid" onblur="newempidval()"> </input>
									...
									<div  id="tr5" style="display: none;">
									   <div>
									     <font color="black"><b>HOD Email Id:</b> </font> 
									   </div>
									   <div><font color="black" id="HOD"></font> 
     			 		                  <input type="hidden" name="oldHOD" id="oldHOD" value="">
                                            <a href = "#"  onclick = "showtext()"> <font color="blue" size="2">Change HOD</font> </a>
                                        </div>
									</div>
									
									<div class="row" id="tr6" style="display: none;">
									 <label class="tcolor">HOD:</label>
									<div>
									   <input type="text" name="newHOD" id="newHOD" onblur="hodval()" placeholder="Enter HOD"></input> 
      			                       <label name="hodn" id="hodn" style="display: none;"><font color="red">Please Enter HOD</font></label>
                                    </div>
									</div>
									
									<div class="row"  id="tr7" style="display: none;">
									 <label class="tcolor">Email:</label>
									 <input class="form-control" type="text"
									    name="email" id="email" onblur="emailval()"
									...
									<div class="row"  id="tr10" style="display: none;">
									...
									<div class="d-grid col-5 mx-auto mb-1">
												...
												<div class="input-group input-group-merge">
													<input type="text" id="calender" name="calender"
														class="form-control" value="<%=sdt%>"readonly> <span
									...
									<%
 		                         	}   //End IF inside the Hidden section...
 		                          %>
    ...
    <div id="tp" name="tp"></div>
									...
									<div class="d-grid col-5 mx-auto mb-1">
												...
												<div class="input-group input-group-merge">
													<input type="text" id="calender" name="calender"
														class="form-control" value="<%= new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(sdt))%>" readonly> <span
														class="input-group-text"><svg
															xmlns="http://www.w3.org/2000/svg" width="14" height="14"
															viewBox="0 0 24 24" fill="none" stroke="currentColor"
															stroke-width="2" stroke-linecap="round"
